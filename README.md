...
This README file contains the necessary steps for setting up a Jenkins CI/CD pipeline for a Java Spring Boot project using Tomcat as the application server. We will be using the sample project at (https://github.com/Ramkhushi/java-code1.git)
...
![image](https://github.com/Ramkhushi/Jenkins-cicd/assets/120269399/3c9cea76-775f-421d-90f3-072aec0c7ceb)
![image](https://github.com/Ramkhushi/Jenkins-cicd/assets/120269399/9910af66-7451-405f-a6c1-82de8ac031cd)


 - [ ] Check your Application at context name given
```
ip:8080/app
```
